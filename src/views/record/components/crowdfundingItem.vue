    ...
    <div class="f-box1">
        <div class="so-nav">
            <div class="zx-box1" style="margin-left:20px">
                ...
                <el-select class="se-nav" v-model="shop_type" filterable placeholder="请选择">
                    <el-option
            ...
            <div class="zx-box1" style="margin-left:20px">
                <span class="queue-s01">拼桌方式</span>
                <el-select class="se-nav" v-model="cf_type" filterable placeholder="请选择">
                    <el-option
                        v-for="item in cftypeArr"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                    </el-option>
...
export default {
    ...
    methods:{
        ...
        filtrateFun(n) {
            if(n!=2){
                this.$emit('filtrateFun', this.shop_type, this.cf_type, this.status, this.start, this.end, this.charts_type, n)
            }else{
