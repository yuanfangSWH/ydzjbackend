...
<div class="add-box">
    <div class="f-box1">
        ...
        <div class="timeBox">
            ...
            <div style="display:flex; margin-top:20px">
                <span class="s01">是否到场</span>
                <div style="margin-left:10px">
                    <el-radio-group v-model="is_arrive">
...
export default {
    ...
    methods:{
        ...
        filtrateFun(n) {
            if(n!=2){
                this.$emit('filtrateFun', this.shop_type, this.status, this.start, this.end, this.charts_type,this.is_arrive, n)
            }else{
