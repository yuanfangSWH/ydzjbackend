  ...
  <div class="add-box">
    ...
    <div class="selectBox">
      <div class="zx-box1"
        ...
        <span class="queue-s01">举报类型</span>
...
export default {
  ...
  mounted () {
    for (var i = 0; i < this.options.length; i++) {
      if (this.type == Number(this.options[i].value)) {
        this.sceneText = this.options[i].label;
      }
    }
  },
  watch: {
