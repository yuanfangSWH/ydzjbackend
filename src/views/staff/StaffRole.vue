<template>
  <div class="shopSet">
    ...
    >
      ...
      <el-table-column label="全选/角色ID" width="120">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="name" label="角色名称" width="150" />
      <el-table-column prop="commission" label="提成" width="150" />
      <el-table-column prop="gift_amount" label="赠送额度" width="150" />
    ...
    <el-dialog title="新增" :visible.sync="insertDialog">
      ...
      >
        ...
        <el-form-item label="赠送额度" prop="gift_amount">
          <el-input v-model="addItem.gift_amount" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
          <el-switch v-model="status_ui" active-color="#13ce66"></el-switch>
        </el-form-item>
...
export default {
  ...
  created() {
    ...
    this.currenItem.merchant_id = Number(this.$route.query.merchant_id);
    this.currenItem.shop_id = Number(this.$route.query.shop_id);
    this.getTableList();
    this.menuAllTree();
  },
  methods: {
